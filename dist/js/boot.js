...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template/components/header.html',
    ...
    '				<a class="nav-link" title="Sync to Server" ng-click="context.commonFact.syncServer()">\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template/components/mappingForm.html',
    ...
    '            </tbody>\n' +
    '        </table>\n' +
    '		{{context.controller.form.mapping}}\n' +
