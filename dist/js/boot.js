...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template/components/autoComplete.html',
    ...
    '		<li ng-show="field.isFilterBy || field.isFilterBy || key1!==0" ng-repeat="(key1, option) in field.autoCompleteOptions" ng-class="{\'list-group-item\': true, \'list-group-item-active\': field.selectedOption==key1}" ng-click="context.commonFact.fillAutoComplete(option, field, map, key)">{{option.optionName}}</li>\n' +
    '	</ul>\n' +
    '</div>\n' +
    '');
}]);
