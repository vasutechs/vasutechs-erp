...
erpApp.controller('appUsersCtrl', ['$scope', 'commonFact', function($scope, commonFact) {
    var actions = {
        callBackList: function(context) {
            var adminOption = {
                userType: 'ADMIN',
    ...
    commonFact.initCtrl($scope, 'appAdmin.appUsers', actions);
}]);
...
erpApp.controller('userTypesCtrl', ['$scope', 'commonFact', function($scope, commonFact) {
    commonFact.initCtrl($scope, 'appAdmin.userTypes');
}]);
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template/defaultView.html',
    ...
    '                        <p class="font-italic" ng-if="!context.cashBill"><b>GSTIN:</b> {{context.erpAppConfig.companyGstin}}</p>\n' +
    '                    </div>\n' +
    '                </div>\n' +
    '                <div class="card-body">\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template/components/header.html',
    ...
    '                </li>\n' +
    '            </ul>\n' +
    '            <ul ng-if="headerContext.modules" class="navbar-nav ml-auto">\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template/controllers/marketing/invoice.html',
    ...
    '                <div ng-if="context.page.printView" class="row">\n' +
    '                    <div class="col-8">\n' +
    '                        <img ng-if="context.erpAppConfig.companyLogoUrl" class="logo" src="{{context.erpAppConfig.companyLogoUrl}}" title="{{context.erpAppConfig.companyName}}" />\n' +
    '                        <h1 ng-if="!context.erpAppConfig.companyLogoUrl" class="logo">{{context.erpAppConfig.companyName}}</h1>\n' +
    '                    </div>\n' +
    '                    <div class="col-4">\n' +
    '\n' +
