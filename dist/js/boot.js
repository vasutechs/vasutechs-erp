...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template/components/filterView.html',
    ...
    '                    {{list.title}}:<select ng-if="list.type===\'select\'" id="{{list.id}}" class="form-control font-weight-bold" ng-model="list.selectedFilterBy" ng-change="context.commonFact.callActions(list.action, [list]) || context.commonFact.viewFilterBy(list)"\n' +
    '                        ng-options="option.optionId as option.optionName for option in list.options">\n' +
    '                        <option value="">--Select--</option>\n' +
    '                    </select> <input ng-if="list.type===\'input\'" type="{{list.inputType}}" class="form-control font-weight-bold" ng-model="list.selectedFilterBy" ng-change="context.commonFact.callActions(list.action, [list]) || context.commonFact.viewFilterBy(list)"\n' +
    '                    />\n' +
    '                </th>\n' +
    '            </tr>\n' +
    '        </thead>\n' +
