...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template/components/mappingForm.html',
    ...
    '                        <select class="form-control" ng-switch-when="select" id="{{field.id}}-{{key}}" ng-focus="field.focusAction && context.actions[field.focusAction] && context.actions[field.focusAction](context, map, map[field.id], field, this)" ng-change="field.action && context.actions[field.action] && context.actions[field.action](context, map, map[field.id], field, this)"\n' +
