...
erpApp.directive('header', ['commonFact', '$location', 'authFact', function(commonFact, $location, authFact) {
    var headerComp = function($scope, element, attrs) {
        ...
        headerContext.showDownload = false;
        for (var i = 10; i >= 0; i--) {
