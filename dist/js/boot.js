...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template/components/alertRol.html',
    ...
    '                    <button type="button" class="btn btn-default" ng-click="context.alertRolContext.showROL=false" data-dismiss="modal">OK</button>\n' +
