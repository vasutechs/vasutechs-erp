erpApp.controller('empMasterCtrl', ['erpAppConfig', '$scope', 'serviceApi', '$location', 'commonFact', function(erpAppConfig, $scope, serviceApi, $location, commonFact) {
    var actions = {
    ...
    $scope.context = erpAppConfig.modules.master.empMaster;
